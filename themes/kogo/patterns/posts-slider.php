...
<!-- wp:query {"query":{"perPage":20,"pages":0,"offset":0,"postType":"post","categoryIds":[<?php echo $news_category_id; ?>],"order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"align":"full","className":"kogo-posts-slider swiper","layout":{"type":"default"}} -->
